...
#include "agv_msgs/srv/detail/move__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/twist__functions.h"  // command

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_agv_msgs
...
using _Move_Request__ros_msg_type = agv_msgs__srv__Move_Request;
...
size_t get_serialized_size_agv_msgs__srv__Move_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_Request__ros_msg_type * ros_message = static_cast<const _Move_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Move_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_agv_msgs__srv__Move_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_msgs
size_t max_serialized_size_agv_msgs__srv__Move_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agv_msgs__srv__Move_Request;
    is_plain =
      (
...
static size_t _Move_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agv_msgs__srv__Move_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_msgs, srv, Move_Request)() {
...
using _Move_Response__ros_msg_type = agv_msgs__srv__Move_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_msgs
size_t get_serialized_size_agv_msgs__srv__Move_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Move_Response__ros_msg_type * ros_message = static_cast<const _Move_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_agv_msgs__srv__Move_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_agv_msgs
size_t max_serialized_size_agv_msgs__srv__Move_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agv_msgs__srv__Move_Response;
    is_plain =
      (
...
static size_t _Move_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_agv_msgs__srv__Move_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_msgs, srv, Move_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, agv_msgs, srv, Move)() {
  return &Move__handle;
}
