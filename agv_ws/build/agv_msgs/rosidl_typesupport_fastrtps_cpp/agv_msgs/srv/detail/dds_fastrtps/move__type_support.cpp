...
#include "agv_msgs/srv/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agv_msgs::srv::Move_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_msgs::srv::Move_Request & ros_message)
{
  // Member: command
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agv_msgs::srv::Move_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agv_msgs::srv::Move_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agv_msgs::srv::Move_Request *>(
    untyped_ros_message);
...
{
  return &agv_msgs::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_msgs, srv, Move_Request)() {
  return &agv_msgs::srv::typesupport_fastrtps_cpp::_Move_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_agv_msgs
cdr_serialize(
  const agv_msgs::srv::Move_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agv_msgs::srv::Move_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = agv_msgs::srv::Move_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agv_msgs::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<agv_msgs::srv::Move_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &agv_msgs::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_msgs, srv, Move_Response)() {
  return &agv_msgs::srv::typesupport_fastrtps_cpp::_Move_Response__handle;
}
...
{
  return &agv_msgs::srv::typesupport_fastrtps_cpp::_Move__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agv_msgs, srv, Move)() {
  return &agv_msgs::srv::typesupport_fastrtps_cpp::_Move__handle;
}
