...
{
  new (message_memory) agv_msgs::srv::Move_Request(_init);
}

void Move_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<agv_msgs::srv::Move_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Move_Request_message_member_array[1] = {
  {
    ...
    offsetof(agv_msgs::srv::Move_Request, command),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Move_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(agv_msgs::srv::Move_Request),
...
{
  return &::agv_msgs::srv::rosidl_typesupport_introspection_cpp::Move_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, agv_msgs, srv, Move_Request)() {
  return &::agv_msgs::srv::rosidl_typesupport_introspection_cpp::Move_Request_message_type_support_handle;
}
...
void Move_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) agv_msgs::srv::Move_Response(_init);
}

void Move_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<agv_msgs::srv::Move_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Move_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(agv_msgs::srv::Move_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Move_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(agv_msgs::srv::Move_Response),
...
{
  return &::agv_msgs::srv::rosidl_typesupport_introspection_cpp::Move_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, agv_msgs, srv, Move_Response)() {
  return &::agv_msgs::srv::rosidl_typesupport_introspection_cpp::Move_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Move_service_members = {
  ...
  // see get_service_type_support_handle<agv_msgs::srv::Move>()
...
get_service_type_support_handle<agv_msgs::srv::Move>()
{
  ...
  auto service_type_support =
    &::agv_msgs::srv::rosidl_typesupport_introspection_cpp::Move_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, agv_msgs, srv, Move)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<agv_msgs::srv::Move>();
}
