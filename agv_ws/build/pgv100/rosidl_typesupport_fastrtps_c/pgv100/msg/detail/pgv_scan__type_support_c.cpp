...
#include "pgv100/msg/detail/pgv_scan__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_pgv100
...
using _PGVScan__ros_msg_type = pgv100__msg__PGVScan;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PGVScan__ros_msg_type * ros_message = static_cast<const _PGVScan__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: color_lane_count
  {
    cdr << ros_message->color_lane_count;
  }

  // Field name: no_color_lane
  {
    cdr << ros_message->no_color_lane;
  }

  // Field name: no_position
  {
    cdr << ros_message->no_position;
  }

  // Field name: tag_detected
  {
  ...
  void * untyped_ros_message)
{
  ...
  _PGVScan__ros_msg_type * ros_message = static_cast<_PGVScan__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_pgv100__msg__PGVScan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PGVScan__ros_msg_type * ros_message = static_cast<const _PGVScan__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _PGVScan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pgv100__msg__PGVScan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_pgv100
size_t max_serialized_size_pgv100__msg__PGVScan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pgv100__msg__PGVScan;
    is_plain =
      (
...
static size_t _PGVScan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pgv100__msg__PGVScan(
...
static message_type_support_callbacks_t __callbacks_PGVScan = {
  "pgv100::msg",
  "PGVScan",
...
static rosidl_message_type_support_t _PGVScan__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pgv100, msg, PGVScan)() {
  return &_PGVScan__type_support;
}
