...
class WheelController(Node):
    def __init__(self):
        ...
        self.get_logger().info("Initializing WheelController node")
        ...
        self.get_logger().info("Subscribed to command_topic")
    ...
    def update_movement(self):
        ...
        if abs(remaining_distance) <= 0.01 and abs(remaining_angle) <= 0.01:
            self.get_logger().info(f'Target reached. Stopping movement. Traveled distance: {self.traveled_distance} m, Traveled angle: {self.traveled_angle} radians.')
