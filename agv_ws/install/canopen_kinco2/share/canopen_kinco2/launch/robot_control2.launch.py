...
def generate_launch_description():
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("canopen_kinco2"),
                    "urdf",
                    "robot_controller",
    ...
    robot_control_config = PathJoinSubstitution(
        [FindPackageShare("canopen_kinco2"), "config/robot_control", "ros2_controllers.yaml"]
    )
    ...
    slave_config = PathJoinSubstitution(
        [FindPackageShare("canopen_kinco2"), "config/robot_control", "KincoCMDriver.eds"]
    )
