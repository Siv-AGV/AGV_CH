...
class SimpleController(Node):
    ...
    def update_movement(self):
        if self.moving:
            ...
            self.current_wheel_speed_conv_L = int(np.nan_to_num(((self.wheel_speed[0] / (2 * math.pi)) * 60 * 512 * 10000) / 1875))
            self.current_wheel_speed_conv_R = -int(np.nan_to_num(((self.wheel_speed[1] / (2 * math.pi)) * 60 * 512 * 10000) / 1875))
